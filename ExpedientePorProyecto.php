...
<html>
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="RevisionesPorProyecto.php">
                <i class="fa fa-check-square-o"></i>
                <span>Revisiones</span>
              </a>
            </li>
            <li>
              <a href="CreacionDeFuturasReunionesEnCalendario.php">
            ...
            <li>
            <a href="ExpedientePorProyecto.php">
            <i class="fa fa-book"></i> <span>Expediente</span>
            </a></li>

            <li class="active ">
            <a href="estados.php">
            <i class="glyphicon glyphicon-envelope"></i> <span>Correo</span>
            </a>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Expedientes
            <small>  Expedientes que se han subido del proyecto</small>
          </h1>
 ...
 <!-- AQUI COMIENZA A PONER CODIGO SUYO -->
        ...
        <div class="btn btn-success btn-file">
         ...
         <span class="glyphicon glyphicon-download-alt"></span> Descargar
          ...
          <span class="glyphicon glyphicon-folder-open"></span> Subir
        </a>
                 </div>
